...
| code                                           | 銀行口座パターンコード※必須 <br> ※登録後は変更できません | 20   | [半角英数\*4](/README.md#種別注釈) |      |
| name                                           | 銀行口座パターン管理名※必須                              | 40   | 文字列                             |      |
| text                                           | 請求書表示※必須                                          | 256  | 文字列                             |      |
| bs_bank_transfer_pattern.link_bs_bank_transfer | 請求元銀振口座パターン関連に属するパラメータ             |      |                                    |      |
| code                                           | 銀行口座コード※必須※関連する銀行口座を指定               | 20   | [半角英数\*4](/README.md#種別注釈) |      |
