...
| bank_name                     | 銀行名                                               | 15   | 文字列                             | [(登録時)](/README.md#必須) |
| branch_code                   | 支店コード                                           | 3    | 数値                               |                             |
| branch_name                   | 支店名                                               | 15   | 文字列                             | [(登録時)](/README.md#必須) |
| bank_account_type             | 預金種目1:普通 2:当座                                | 1    | 数値                               | [(登録時)](/README.md#必須) |
| bank_account_number           | 口座番号                                             | 7    | 数値                               | [(登録時)](/README.md#必須) |
| bank_account_name             | 口座名義                                             | 30   | [半角英数\*5](/README.md#種別注釈) | [(登録時)](/README.md#必須) |
| bs_department_code            | 請求元部署コード  <br> ※未所属の場合は「0000」を指定 | 20   | [半角英数\*4](/README.md#種別注釈) | 必須                        |
| journal_cooperation_bank_code | 会計ソフト連携用銀行コード                           | 33   | [半角英数\*3](/README.md#種別注釈) |                             |
