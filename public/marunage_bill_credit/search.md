...
| [marunage_bill_credit](#marunage_bill_credit-request) | 債権譲渡申請に属するパラメータ                                     |     | `object`                   |  |
...
| 名前               | 概要           | 桁数 | 種別                                  | 必須 |
|------------------|--------------|---|-------------------------------------|---|
| bill_number      | 請求書番号        | 100 | 配列（ [半角英数 + 記号](../../index.md#種別)） |  |
| status           | 債権譲渡申請ステータス  | 1 | 配列（数値）                              |   |
| apply_date_from  | 債権譲渡申請日（開始日） | 10 | 日付                                  |   |
| apply_date_to    | 債権譲渡申請日（終了日） | 10 | 日付                                  |   |
| answer_date_from | 債権譲渡回答日（開始日） | 10 | 日付                                  |   |
| answer_date_to   | 債権譲渡回答日（終了日） | 10 | 日付                                  |   |
