...
指定の請求先のまるなげ与信を停止申請します。既に与信が有効な請求先に対してのみ行えます。<br>リクエスト上限は3000件です。
...
| marunage_credit | まるなげ与信停止申請に属するパラメータ   |      | `array`                          |      |
...
| reason        | 停止理由                       | string  |
| status        | まるなげ与信停止申請状態<br> 0: 却下<br> 1: 承認<br> 2: 申請中 | int      |
