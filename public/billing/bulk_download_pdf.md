...
| 名前                        | 概要                               | 桁数 | 種別                              | 必須 |
| --------------------------- | ---------------------------------- | ---- | --------------------------------- | ---- |
| user_id                     | ユーザID（管理画面へのログインID） | 100  | [メール形式](/README.md#種別注釈) | 必須 |
| access_key                  | アクセスキー                       | 10   | [半角英数](/README.md#種別注釈)   | 必須 |
...
| 名前                                       | 概要                       | 桁数 | 種別                                   | 必須 |
| ------------------------------------------ | -------------------------- | ---- | -------------------------------------- | ---- |
| code                                       | 請求先コード               | 20   | [半角英数 + 記号](/README.md#種別注釈) | 必須 |
...
| code   | 決済情報コード | 20   | [半角英数 + 記号](/README.md#種別注釈) | (必須)^1 |
