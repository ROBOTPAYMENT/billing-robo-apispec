...
| billing                              | 請求先に属するパラメータ                                                                                                                                                                                                                    |          |                    | 必須 |
| code                                 | 請求先コード  <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                         | 20       | 半角英数*4         |      |
| name                                 | 請求先名 <br> ※追加時、必須 <br> ※両端のスペース除去                                                                                                                                                                                        | 100      | 文字列             |      |
| billing.individual                   | 請求先部署に属するパラメータ                                                                                                                                                                                                                |          |                    |      |
| number                               | 請求先部署番号 <br> ※更新時、「請求先部署番号」または「請求先部署コード」何れかを必須 <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                 | 18       | 数値               |      |
| code                                 | 請求先部署コード <br> ※更新時、「請求先部署番号」または「請求先部署コード」何れかを必須 <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                               | 20       | 半角英数*4         |      |
| name                                 | 請求先部署名 <br> ※追加時、必須 <br> ※両端のスペース除去                                                                                                                                                                                    | 100      | 文字列             |      |
| link_customer_code                   | 会計ソフト連携用取引先コード <br> ※追加省略時、nullで登録される                                                                                                                                                                             | 20       | 半角英数*3         |      |
| address1                             | 宛名1 <br> ※追加時、必須 <br> ※両端のスペース除去                                                                                                                                                                                           | 60       | 文字列             |      |
| address2                             | 宛名2 <br> ※両端のスペース除去 <br> ※追加省略時、nullで登録される                                                                                                                                                                           | 60       | 文字列             |      |
| address3                             | 宛名3 <br> ※両端のスペース除去 <br> ※追加省略時、nullで登録される                                                                                                                                                                           | 60       | 文字列             |      |
| zip_code                             | 郵便番号 <br> ※追加時、必須 <br> ※両端のスペース除去 <br> ※ハイフンありなしどちらでも可                                                                                                                                                     | 7        | 文字列             |      |
| pref                                 | 都道府県 <br> ※追加時、必須                                                                                                                                                                                                                 | 4        | 文字列             |      |
| city_address                         | 市区町村番地 <br> ※追加時、必須 <br> ※両端のスペース除去                                                                                                                                                                                    | 56       | 文字列             |      |
| building_name                        | 建物名 <br> ※両端のスペース除去 <br> ※追加省略時、nullで登録される                                                                                                                                                                          | 60       | 文字列             |      |
| set_post_address                     | 郵送宛先情報 <br> 0:使用しない 1:使用する <br> ※省略時は、0と同義                                                                                                                                                                           | 1        | 数値               |      |
| post_address1                        | 郵送先宛名1 <br> ※追加時、郵送宛先情報が1の場合に必須 <br> ※両端のスペース除去 <br> ※追加省略時、nullで登録される                                                                                                                           | 60       | 文字列             |      |
| post_address2                        | 郵送先宛名2 <br> ※両端のスペース除去 <br> ※追加省略時、nullで登録される                                                                                                                                                                     | 60       | 文字列             |      |
| post_address3                        | 郵送先宛名3 <br> ※両端のスペース除去 <br> ※追加省略時、nullで登録される                                                                                                                                                                     | 60       | 文字列             |      |
| post_zip_code                        | 郵送先郵便番号 <br> ※追加時、郵送宛先情報が1の場合に必須 <br> ※両端のスペース除去 <br> ※ハイフンありなしどちらでも可                                                                                                                        | 7        | 文字列             |      |
| post_pref                            | 郵送先都道府県 <br> ※追加時、郵送宛先情報が1の場合に必須 <br> ※追加省略時、nullで登録される                                                                                                                                                 | 4        | 文字列             |      |
| post_city_address                    | 郵送先市区町村番地 <br> ※追加時、郵送宛先情報が1の場合に必須 <br> ※両端のスペース除去 <br> ※追加省略時、nullで登録される                                                                                                                    | 56       | 文字列             |      |
| post_building_name                   | 郵送先建物名 <br> ※両端のスペース除去 <br> ※追加省略時                                                                                                                                                                                      | 60       | 文字列             |      |
| tel                                  | 電話番号 <br> ※追加時、payment_method=1,2,6,7,8の場合のみ必須 <br> ※両端のスペース除去 <br> ※追加省略時、nullで登録される                                                                                                                   | 15       | 数値、半角ハイフン |      |
| email                                | メールアドレス <br> ※追加時、必須 <br> ※両端のスペース除去                                                                                                                                                                                  | 100      | 半角英数*1         |      |
| cc_email                             | CC送信先メールアドレス <br> ※両端のスペース除去 <br> ※追加省略時、nullで登録される                                                                                                                                                          | 256      | 半角英数*1         |      |
...
| payment_method_code                  | 決済情報コード <br> ※追加省略時、nullで登録される                                                                                                                                                                                           | 20       | 半角英数*4         |      |
| bs_owner_code                        | 請求元担当者コード <br> ※追加省略時、nullで登録される                                                                                                                                                                                       | 20       | 半角英数*4         |      |
| ref_billing_code                     | 合計請求書用請求先コード <br> ※追加省略時、nullで登録される                                                                                                                                                                                 | 20       | 半角英数*4         |      |
| ref_individual_number                | 合計請求書用請求先部署番号 <br> ※合計請求書の場合、「合計請求書用請求先部署番号」または「合計請求書用請求先部署コード」何れかを必須 <br> ※追加省略時、nullで登録される                                                                      | 18       | 数値               |      |
| ref_individual_code                  | 合計請求書用請求先部署コード <br> ※合計請求書の場合、「合計請求書用請求先部署番号」または「合計請求書用請求先部署コード」何れかを必須 <br> ※追加省略時、nullで登録される                                                                    | 20       | 半角英数*4         |      |
...
| billing.individual.sub_account_title | 請求先部署補助科目に属するパラメータ ※省略可能                                                                                                                                                                                              |          |                    |      |
...
| number                               | 決済情報番号 <br> ※更新時、「決済情報番号」または「決済情報コード」何れかを必須 <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                       | 18       | 半角数字           |      |
| code                                 | 決済情報コード <br> ※更新時、「決済情報番号」または「決済情報コード」何れかを必須 <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                     | 20       | 半角英数*4         |      |
| name                                 | 決済情報名 <br> ※追加時、必須                                                                                                                                                                                                               | 100      | 文字列             |      |
| bank_transfer_pattern_code           | 請求元銀行口座パターンコード <br> ※payment_method=0の場合に必要(入力は任意) <br> ※追加省略時、1で登録される                                                                                                                                 | 20       | 半角英数*4         |      |
| payment_method                       | 決済手段 <br> 0:銀行振込 1:クレジットカード 2:バンクチェック <br> 3:RP口座振替 4:RL口座振替 5:その他口座振替 <br> 6:コンビニ払込票(A4) 7:コンビニ払込票(ハガキ) 9:バーチャル口座 <br> ※追加時、必須                                         | 1        | 数値               |      |
| source_bank_account_name             | 振込元口座名義 <br> ※payment_method=0,2,9の場合に必要(入力は任意) <br> ※追加省略時、空で登録される <br> ※エンドユーザーの口座名義になります                                                                                                 | 48       | 半角英数*5         |      |
| customer_number                      | 顧客番号 <br> ※payment_method=5の場合に必要(入力は任意) <br> ※追加省略時、nullで登録される                                                                                                                                                  | 20       | 半角英数*3         |      |
| bank_code                            | 銀行コード <br> ※payment_method=3,4,5,9の場合に必要(入力は任意) <br> ※追加省略時、空で登録される                                                                                                                                            | 4        | 数値               |      |
| bank_name                            | 銀行名 <br> ※payment_method=5の場合に必要(入力は任意) <br> ※ゆうちょの場合は「ﾕｳﾁﾖ」 <br> ※追加省略時、nullで登録される                                                                                                                     | 15       | 半角英数*6         |      |
| branch_code                          | 支店コード <br> ※payment_method=3,4,5,9の場合に必要(入力は任意) <br> ※追加省略時、空で登録される <br> ※payment_method=3でゆうちょの時の桁数は5桁                                                                                            | 3または5 | 数値               |      |
| branch_name                          | 支店名 <br> ※payment_method=5の場合に必要(入力は任意) <br> ※追加省略時、nullで登録される                                                                                                                                                    | 15       | 半角英数*6         |      |
| bank_account_type                    | 預金種目 <br> 1:普通 2:当座 <br> ※追加省略時、payment_method=3,4,5,9の場合に必須                                                                                                                                                            | 1        | 数値               |      |
...
| bank_account_name                    | 口座名義 <br> ※payment_method=3,4,5の場合に必要(入力は任意) <br> ※payment_method=3の場合の桁数は30桁 <br> ※payment_method=3の場合は半角スペース入力不可 <br> ※追加省略時、空で登録される                                                    | 30       | 半角英数*5         |      |
| credit_card_regist_kind              | クレジットカード登録方法 <br> 1:あとで登録 2:登録用メールを送付 <br> ※payment_method=1の場合に必要(入力は任意) <br> ※追加省略時、1で登録される                                                                                              | 1        | 数値               |      |
| credit_card_email                    | クレジットカード登録メール送信先 <br> ※credit_card_regist_kind=2の場合に必要(入力は任意) <br> ※追加省略時、emailで入力したメールアドレスに送信される                                                                                        | 100      | 半角英数*1         |      |
| billing.sub_account_tfitle           | 請求先補助科目に属するパラメータ <br> ※今後拡張予定です。現在利用はできません。                                                                                                                                                             |          |                    |      |
| account_title_code                   | 勘定科目コード                                                                                                                                                                                                                              | 20       | 半角英数*4         | 必須 |
