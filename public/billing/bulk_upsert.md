...
| code                                 | 請求先コード  <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                         | 20       | [半角英数\*4](/README.md#種別注釈) |      |
...
| code                                 | 請求先部署コード <br> ※更新時、「請求先部署番号」または「請求先部署コード」何れかを必須 <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                               | 20       | [半角英数\*4](/README.md#種別注釈) |      |
...
| email                                | メールアドレス <br> ※追加時、必須 <br> ※両端のスペース除去                                                                                                                                                                                  | 100      | [半角英数\*1](/README.md#種別注釈) |      |
...
| ref_individual_code                  | 合計請求書用請求先部署コード <br> ※合計請求書の場合、「合計請求書用請求先部署番号」または「合計請求書用請求先部署コード」何れかを必須 <br> ※追加省略時、nullで登録される                                                                    | 20       | [半角英数\*4](/README.md#種別注釈) |      |
...
| code                                 | 決済情報コード <br> ※更新時、「決済情報番号」または「決済情報コード」何れかを必須 <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                     | 20       | [半角英数\*4](/README.md#種別注釈) |      |
