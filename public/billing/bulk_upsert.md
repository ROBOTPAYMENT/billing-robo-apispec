...
| code                                                                              | 請求先部署コード <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                      | 20   | [半角英数 + 記号](/README.md#種別)        | (更新時)^1                           |
| name                                                                              | 請求先部署名  <br> ※両端のスペース除去                                                                                                                                                                                                      | 100  | 文字列                                        |                                      |
| link_customer_code                                                                | 会計ソフト連携用取引先コード <br> ※追加省略時、nullで登録される                                                                                                                                                                             | 20   | [半角英数](/README.md#種別)               |                                      |
...
| email                                                                             | メールアドレス  <br> ※両端のスペース除去                                                                                                                                                                                                    | 100  | [メール形式](/README.md#種別)             | (追加時)                             |
| cc_email                                                                          | CC送信先メールアドレス <br> ※両端のスペース除去 <br> ※追加省略時、nullで登録される                                                                                                                                                          | 256  | [メール形式](/README.md#種別)             |                                      |
...
| payment_method_code                                                               | 決済情報コード <br> ※追加省略時、nullで登録される                                                                                                                                                                                           | 20   | [半角英数 + 記号](/README.md#種別)        |                                      |
| bs_owner_code                                                                     | 請求元担当者コード <br> ※追加省略時、nullで登録される                                                                                                                                                                                       | 20   | [半角英数 + 記号](/README.md#種別)        |                                      |
| ref_billing_code                                                                  | 合計請求書用請求先コード <br> ※追加省略時、nullで登録される                                                                                                                                                                                 | 20   | [半角英数 + 記号](/README.md#種別)        |                                      |
...
| code                       | 決済情報コード <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                     | 20       | [半角英数 + 記号](/README.md#種別) | (更新時)^3                         |
| name                       | 決済情報名                                                                                                                                                                               | 100      | 文字列                                 | (追加時)                           |
| bank_transfer_pattern_code | 請求元銀行口座パターンコード <br> ※payment_method=0の場合に必要(入力は任意) <br> ※追加省略時、1で登録される                                                                              | 20       | [半角英数 + 記号](/README.md#種別) |                                    |
...
| source_bank_account_name   | 振込元口座名義 <br> ※payment_method=0,2,9の場合に必要(入力は任意) <br> ※追加省略時、空で登録される <br> ※エンドユーザーの口座名義になります                                              | 48       | [口座名義](/README.md#種別)        |                                    |
| customer_number            | 顧客番号 <br> ※payment_method=5の場合に必要(入力は任意) <br> ※追加省略時、nullで登録される                                                                                               | 20       | [半角英数](/README.md#種別)        |                                    |
| bank_code                  | 銀行コード <br> ※payment_method=3,4,5,9の場合に必要(入力は任意) <br> ※追加省略時、空で登録される                                                                                         | 4        | 数値                                   |                                    |
| bank_name                  | 銀行名 <br> ※payment_method=5の場合に必要(入力は任意) <br> ※ゆうちょの場合は「ﾕｳﾁﾖ」 <br> ※追加省略時、nullで登録される                                                                  | 15       | [銀行名等](/README.md#種別)        |                                    |
| branch_code                | 支店コード <br> ※payment_method=3,4,5,9の場合に必要(入力は任意) <br> ※追加省略時、空で登録される <br> ※payment_method=3でゆうちょの時の桁数は5桁                                         | 3または5 | 数値                                   |                                    |
| branch_name                | 支店名 <br> ※payment_method=5の場合に必要(入力は任意) <br> ※追加省略時、nullで登録される                                                                                                 | 15       | [銀行名等](/README.md#種別)        |                                    |
...
| bank_account_name          | 口座名義 <br> ※payment_method=3,4,5の場合に必要(入力は任意) <br> ※payment_method=3の場合の桁数は30桁 <br> ※payment_method=3の場合は半角スペース入力不可 <br> ※追加省略時、空で登録される | 30       | [口座名義](/README.md#種別)        |                                    |
