...
| bank_account_name          | 口座名義 <br> ※payment_method=3,4,5の場合に必要(入力は任意) <br> ※payment_method=3の場合の桁数は30桁 <br> ※payment_method=3の場合は半角スペース入力不可 <br> ※追加省略時、空で登録される<br> ※payment_method=9の場合、省略時は自動でバーチャル口座の口座名義が割り当てられる | 30       | [口座名義](../../index.md#種別)        |                                    |
