...
| attachment_planned_flg        | 添付予定 <br> ※ファイル添付機能利用中のみ利用可能                                                                                                                                                                                                                                                                                                                                                       | 1   | 数値 |                                                   |  |
| attachment_flg                | 添付ファイル <br> ※ファイル添付機能利用中のみ利用可能                                                                                                                                                                                                                                                                                                                                                       | 1   | 数値 |                                                   |  |
...
| billing_method                                           | 請求方法 <br> 0:請求無し <br> 1:自動メール <br> 2:手動メール <br> 3:自動郵送 <br> 4:手動郵送 <br> 5:自動メール＋自動郵送 <br> 6:手動メール＋手動郵送 <br> 7:手動マイページ配信 <br> 8:自動マイページ配信配信                                           | int    |                         |
...
| attachment_planned_flg                                   | 添付予定                                                                                                                                                                                    | int     |                       |
| attachment_flg                                           | 添付ファイル                                                                                                                                                                                    | int     |                       |
