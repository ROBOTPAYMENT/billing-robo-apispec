...
| 名前                          | 概要                                                                                                                                                            | 桁数 | 種別                              | 必須                                                 |
| ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | --------------------------------- | ---------------------------------------------------- |
| number                        | 請求書番号                                                                                                                                                      | 100  | [半角英数*4](/README.md#種別) |                                                      |
| billing_code                  | 請求先コード                                                                                                                                                    | 20   | [半角英数*4](/README.md#種別) | (請求先部署番号指定時) <br> (請求先部署コード指定時) |
...
| carryover_transit_bill_number | 繰越先請求書番号                                                                                                                                                | 100  | [半角英数*4](/README.md#種別) |                                                      |
