...
| update_date                                  | 請求書更新日                                                                                                                                                    | date                 |
| confirm_date                                 | 請求書確認日                                                                                                                                                    | date                 |
| mail_send_flg                                | メールステータス <br> 0：未送信 1：送信済み                                                                                                                     | int                  |
| post_send_flg                                | 郵送ステータス <br> 0：未送信 1：送信済み                                                                                                                       | int                  |
| payment_method                               | 決済手段 <br> 0:銀行振込 1:クレジットカード 2:バンクチェック <br> 3:RP口座振替 4:RL口座振替 5:その他口座振替 <br> 6:コンビニ払込票(A4) 7:コンビニ払込票(ハガキ) <br> 8:その他コンビニ払込票 9:バーチャル口座 <br> 10:その他決済1 11:その他決済2 12:その他決済3 <br> 13:その他決済4 14:その他決済5 | int                  |
...
| delete_flg                     | 売上削除フラグ <br> 0:未削除 1:削除 <br> ※現行削除機能は未実装のため未削除が返却されます。                            | int    |
    ...
    "bill": [
        {
            ...
            "delete_flg": 0,
            "gid": "1234567",
            "download_url": "https://sample/download?id=xxxxxxxxxxxxxxxxxxxxxxxxxx",
            "bill_group_key": "",
            "bill_detail": [
                {
                    "bill_detail_id": 1,
                    ...
                    "payment_status": 1,
                    "carryover_flg": 0,
                    "carryover_original_bill_number": null,
                    "valid_flg": 1,
                    "delete_flg": 0
                }
            ]
