...
| billing_code              | 請求先コード <br> ※追加時、必須 <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                                                                                                                                         | 20           | [半角英数\*4](/README.md#種別注釈) |      |
| billing_individual_number | 請求先部署番号 <br> ※追加時、「請求先部署番号」または「請求先部署コード」何れかを必須 <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                                                                                   | 18           | 数値                               |      |
| billing_individual_code   | 請求先部署コード <br> ※追加時、「請求先部署番号」または「請求先部署コード」何れかを必須 <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                                                                                 | 20           | [半角英数\*4](/README.md#種別注釈) |      |
| payment_method_code       | 決済情報コード <br> ※追加時、必須 <br> ※請求先部署に登録されている場合は任意 <br> ※両端のスペース除去                                                                                                                                                                                                                                                                         | 20           | [半角英数\*4](/README.md#種別注釈) |      |
| number                    | 請求情報番号 <br> ※更新時、「請求情報番号」または「請求情報コード」何れかを必須 <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                                                                                         | 18           | 数値                               |      |
| code                      | 請求情報コード <br> ※更新時、「請求情報番号」または「請求情報コード」何れかを必須 <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                                                                                       | 20           | [半角英数\*4](/README.md#種別注釈) |      |
