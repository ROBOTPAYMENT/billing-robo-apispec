...
| billing_code              | 請求先コード  <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                                                                                                                                         | 20           | [半角英数\*4](/README.md#種別注釈) | [(追加時)](/README.md#必須)   |
| billing_individual_number | 請求先部署番号  <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                                                                                                                                       | 18           | 数値                               | [(追加時)^1](/README.md#必須) |
| billing_individual_code   | 請求先部署コード  <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                                                                                                                                     | 20           | [半角英数\*4](/README.md#種別注釈) | [(追加時)^1](/README.md#必須) |
| payment_method_code       | 決済情報コード  <br> ※請求先部署に登録されている場合は任意 <br> ※両端のスペース除去                                                                                                                                                                                                                                                                         | 20           | [半角英数\*4](/README.md#種別注釈) | [(追加時)](/README.md#必須)   |
| number                    | 請求情報番号  <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                                                                                                                                         | 18           | 数値                               | [(更新時)^2](/README.md#必須) |
| code                      | 請求情報コード  <br> ※両端のスペース除去 <br> ※登録後は変更できません                                                                                                                                                                                                                                                                                       | 20           | [半角英数\*4](/README.md#種別注釈) | [(更新時)^2](/README.md#必須) |
| item_code                 | 商品コード <br> ※商品マスタに登録されているコード <br> ※追加省略時、nullで登録される <br> ※登録後は変更できません                                                                                                                                                                                                                                           | 20           | [半角英数\*4](/README.md#種別注釈) |                               |
| type                      | 請求タイプ <br> 0:単発 1:定期定額 2:定期従量  <br> ※商品マスタに登録されている場合は任意 <br> ※登録後は変更できません                                                                                                                                                                                                                                       | 1            | 数値                               | [(追加時)](/README.md#必須)   |
...
| goods_name                | 商品名  <br> ※商品マスタに登録されている場合は任意 <br> ※両端のスペース除去                                                                                                                                                                                                                                                                                 | 60           | 文字列                             | [(追加時)](/README.md#必須)   |
...
| tax_category              | 税区分 <br> 0:外税 1:内税 2:対象外 3:非課税  <br> ※商品マスタに登録されている場合は任意                                                                                                                                                                                                                                                                     | 1            | 数値                               | [(追加時)](/README.md#必須)   |
...
| billing_method            | 請求方法 <br> 0:送付なし 1:自動メール 2:手動メール 3:自動郵送 <br> 4:手動郵送 5:自動メール+自動郵送 6:手動メール+手動郵送  <br> 以下の承認を利用している場合、対応する請求方法を指定するとエラー <br> 請求書メール送付承認：自動メール <br> 請求書郵送承認：自動郵送 <br> 請求書メール+郵送：自動メール+自動郵送 <br> ※請求先部署に登録されている場合は任意 | 1            | 数値                               | [(追加時)](/README.md#必須)   |
...
| start_date                | サービス提供開始日 <br> yyyy/mm/dd  <br> ※登録後は変更できません                                                                                                                                                                                                                                                                                            | 10           | 日付                               | [(追加時)](/README.md#必須)   |
| repeat_count              | 繰返し回数 <br> 0:設定しない または1～36 <br> ※商品マスタに登録されている場合は任意 <br> ※追加省略時、上記type以外は1で登録される                                                                                                                                                                                                                           | 2            | 数値                               | (追加時でtype=1,2時)          |
| period_format             | 対象期間形式 <br> 0：○年○月分 <br> 1：○年○月○日分 <br> 2：○年○月～○年○月 <br> 3：○年○月○日～○年○月○日 <br> 99：非表示  <br> ※商品マスタに登録されている場合は任意                                                                                                                                                                                           | 2            | 数値                               | [(追加時)](/README.md#必須)   |
...
| issue_month               | 請求書発行日_月 <br> 入力可能値:-36～36 <br> 例） <br> -1：前月 <br> 0：当月 <br> 36：36ヵ月後  <br> ※請求先部署に登録されている場合は任意                                                                                                                                                                                                                  | 2            | 数値                               | [(追加時)](/README.md#必須)   |
| issue_day                 | 請求書発行日_日 <br> 入力可能値:1～30、99(末日)  <br> ※請求先部署に登録されている場合は任意                                                                                                                                                                                                                                                                 | 2            | 数値                               | [(追加時)](/README.md#必須)   |
| sending_month             | 請求書送付日_月 <br> 入力可能値:-36～36 <br> 例） <br> -1：前月 <br> 0：当月 <br> 36：36ヵ月後  <br> ※請求先部署に登録されている場合は任意                                                                                                                                                                                                                  | 2            | 数値                               | [(追加時)](/README.md#必須)   |
| sending_day               | 請求書送付日_日 <br> 入力可能値:1～30、99(末日)  <br> ※請求先部署に登録されている場合は任意                                                                                                                                                                                                                                                                 | 2            | 数値                               | [(追加時)](/README.md#必須)   |
| deadline_month            | 決済期限_月 <br> 入力可能値:-36～36 <br> 例） <br> -1：前月 <br> 0：当月 <br> 36：36ヵ月後  <br> ※請求先部署に登録されている場合は任意                                                                                                                                                                                                                      | 2            | 数値                               | [(追加時)](/README.md#必須)   |
| deadline_day              | 決済期限_日 <br> 入力可能値:1～30、99(末日)  <br> ※請求先部署に登録されている場合は任意 <br> ※決済手段がRP口座振替の場合、振替日（10or26）を指定                                                                                                                                                                                                            | 2            | 数値                               | [(追加時)](/README.md#必須)   |
...
| bill_template_code        | 請求書テンプレートコード <br> 10000:基本テンプレート <br> 10010:シンプル  <br> ※請求先部署に登録されている場合は任意 <br> ※合計請求書をご利用される場合は、お手数ですがお問い合わせください                                                                                                                                                                 | 18           | 数値                               | [(追加時)](/README.md#必須)   |
