...
| billing_method            | 請求方法 <br> 0:送付なし 1:自動メール 2:手動メール 3:自動郵送 <br> 4:手動郵送 5:自動メール+自動郵送 6:手動メール+手動郵送  <br> 以下の承認を利用している場合、対応する請求方法を指定するとエラー <br> 請求書メール送付承認：自動メール <br> 請求書郵送承認：自動郵送 <br> 請求書メール+郵送：自動メール+自動郵送 <br> ※請求先部署に登録されている場合は任意 <br> ※決済手段がまるなげ口座振替・まるなげバンクチェックの場合は、0,2,4,6(自動系以外)のみ選択可能です | 1            | 数値                                   | (追加時)                      |
