...
`/api/v1.0/demand/bulk_regiseter`
...
| bill_template_code        | 請求書テンプレートコード <br> 10000:基本テンプレート <br> 10010:シンプル <br> ※必須 <br> ※合計請求書はご利用いただけません           | 20          | 数値       |
| tax                       | 消費税率 <br> 画面上で選択できる消費税率のみ入力可能 <br> ※必須                                                                      | 2           | 数値       |
| issue_date                | 初回請求書発行日 <br> yyyy/mm/dd <br> ※必須                                                                                          | 10          | 文字列     |
| sending_date              | 初回請求書送付日 <br> yyyy/mm/dd <br> ※必須                                                                                          | 10          | 文字列     |
| deadline_date             | 初回決済期限 <br> yyyy/mm/dd <br> ※必須                                                                                              | 10          | 文字列     |
| bs_owner_code             | 請求元担当者コード <br> ※両端のスペース除去                                                                                          | 20          | 半角英数*4 |
| jb                        | 決済処理方法 <br> 仮実同時売上:CAPTURE <br> ※必須                                                                                    | 7           | 文字列     |
| bill.detail               | 請求書詳細に属するパラメータ                                                                                                         |             |            |
...
| price                     | 単価 <br> ※demand_type=0,1の場合のみ必須 <br> 両端のスペース除去 <br> ※クレジットカード決済のため桁数上限整数7桁                     | 整数7,小数4 | 数値       |
...
| repeat_count              | 繰返し回数 <br> 0:設定しない または1～36 <br> ※demand_type=1,2以外は"1"固定                                                                                     | string |
