...
| 名前                          | 概要                                                                                                                                                            | 桁数 | 種別       | 必須 |
| ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | ---------- | ---- |
| user_id                       | ユーザーID（管理画面へのログインID） <br> ※必須                                                                                                                 | 100  | 半角英数*1 | 必須 |
| access_key                    | アクセスキー <br>                                                                                                                                               | 100  | 半角英数*3 | 必須 |
...
| billing_individual_code       | 請求先部署コード <br> ※指定する場合、billing_code必須                                                                                                           | 20   | 半角英数*4 |      |
...
| carryover_transit_bill_number | 繰越先請求書番号                                                                                                                                                | 100  | 半角英数*4 |      |
