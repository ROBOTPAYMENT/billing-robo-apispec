...
| 名前                          | 概要                                                                                                                                                            | 桁数 | 種別                                                      | 必須 |
| ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | --------------------------------------------------------- | ---- |
| user_id                       | ユーザーID（管理画面へのログインID） <br> ※必須                                                                                                                 | 100  | [半角英数\*1](/README.md#種別注釈)                        | 必須 |
| access_key                    | アクセスキー <br>                                                                                                                                               | 100  | [[半角英数\*3](/README.md#種別注釈)](/README.md#種別注釈) | 必須 |
...
| billing_individual_number     | 請求先部署番号 <br> ※指定する場合、billing_code必須                                                                                                             | 20   | 数値                                                      |      |
| billing_individual_code       | 請求先部署コード <br> ※指定する場合、billing_code必須                                                                                                           | 20   | [半角英数\*4](/README.md#種別注釈)                        |      |
| issue_start_date              | 発行日の検索開始日 <br> ※発行日、更新日、決済期限のいずれか必須                                                                                                 | 10   | 日付                                                      |      |
| issue_stop_date               | 発行日の検索終了日 <br> ※発行日、更新日、決済期限のいずれか必須                                                                                                 | 10   | 日付                                                      |      |
| update_start_date             | 更新日の検索開始日 <br> ※発行日、更新日、決済期限のいずれか必須                                                                                                 | 10   | 日付                                                      |      |
| update_stop_date              | 更新日の検索終了日 <br> ※発行日、更新日、決済期限のいずれか必須                                                                                                 | 10   | 日付                                                      |      |
| deadline_start_date           | 決済期限の検索開始日 <br> ※発行日、更新日、決済期限のいずれか必須                                                                                               | 10   | 日付                                                      |      |
| deadline_stop_date            | 決済期限の検索終了日 <br> ※発行日、更新日、決済期限のいずれか必須                                                                                               | 10   | 日付                                                      |      |
