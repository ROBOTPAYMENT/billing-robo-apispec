...
| access_key            | アクセスキー                                                                        | 100  | [[半角英数](/README.md#種別注釈)](/README.md#種別注釈) | 必須 |
...
| billing_code                  | 請求先コード                                                                                                                                                    | 20   | [半角英数 + 記号](/README.md#種別注釈) | (billing_individual_number or billing_individual_code入力時) |
...
| carryover_transit_bill_number | 繰越先請求書番号                                                                                                                                                | 100  | [半角英数 + 記号](/README.md#種別注釈) |                                                              |
