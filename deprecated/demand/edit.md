...
| billing_individual_number | 請求先部署番号 <br> ※「請求先部署番号」または「請求先部署コード」何れかを必須 <br> 両端のスペース除去                                  | 20            | 数値       |
| billing_individual_code   | 請求先部署コード <br> ※「請求先部署番号」または「請求先部署コード」何れかを必須 <br> 両端のスペース除去                                | 20            | 半角英数*4 |
| demand_code               | 請求情報番号 <br> ※必須                                                                                                                | 3             | 数値       |
...
| billing_method            | 請求方法 <br> 0:送付なし 1:自動メール 2:手動メール 3:自動郵送 <br> 4:手動郵送 5:自動メール+自動郵送 6:手動メール+手動郵送 <br> ※必須   | 1             | 数値       |
...
| period_format             | 対象期間形式 <br> 0：○年○月分 <br> 1：○年○月○日分 <br> 2：○年○月～○年○月 <br> 3：○年○月○日～○年○月○日 <br> 99：非表示 <br> ※必須       | 1             | 数値       |
