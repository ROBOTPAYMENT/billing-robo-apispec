...
| issue_month               | 請求書発行日_月 <br> 入力可能値:-60～60                                                                                      | 2             | 数値                                   | 必須                  |
| issue_day                 | 請求書発行日_日 <br> 入力可能値:1～30、99(末日)                                                                              | 2             | 数値                                   | 必須                  |
| sending_month             | 請求書送付日_月 <br> 入力可能値: -60～60                                                                                     | 2             | 数値                                   | 必須                  |
| sending_day               | 請求書送付日_日 <br> 入力可能値:1～30、99(末日)                                                                              | 2             | 数値                                   | 必須                  |
| deadline_month            | 決済期限_月 <br> 入力可能値: -60～60                                                                                         | 2             | 数値                                   | 必須                  |
...
| repeat_count              | 繰返し回数 <br> 0:設定しない または1～60 <br> ※demand_type=1,2以外はNULL                                                  | string |
...
| issue_month               | 請求書発行日_月 <br> 入力可能値: -60～60                                                                                  | int    |
| issue_day                 | 請求書発行日_日 <br> 入力可能値:1～30、99(末日)                                                                           | int    |
| sending_month             | 請求書送付日_月 <br> 入力可能値: -60～60                                                                                  | int    |
| sending_day               | 請求書送付日_日 <br> 入力可能値:1～30、99(末日)                                                                           | int    |
| deadline_month            | 決済期限_月 <br> 入力可能値: -60～60                                                                                      | int    |
