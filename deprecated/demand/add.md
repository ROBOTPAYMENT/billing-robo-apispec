...
| billing_individual_number | 請求先部署番号 <br> ※「請求先部署番号」または「請求先部署コード」何れかを必須 <br> seikyu両端のスペース除去                                                                                                                                                                                                                | 20           | 数値       |
| billing_individual_code   | 請求先部署コード <br> ※「請求先部署番号」または「請求先部署コード」何れかを必須 <br> 両端のスペース除去                                                                                                                                                                                                                    | 20           | 半角英数*4 |
| demand_type               | 請求タイプ <br> 0:単発 1:定期定額 2:定期従量 <br> ※必須                                                                                                                                                                                                                                                                    | 1            | 数値       |
| goods_code                | 商品コード                                                                                                                                                                                                                                                                                                                 | 33           | 文字列     |
| link_goods_code           | 会計ソフト連携用商品コード                                                                                                                                                                                                                                                                                                 | 33           | 文字列     |
| goods_name                | 商品名 <br> ※必須                                                                                                                                                                                                                                                                                                          | 60           | 文字列     |
| price                     | 単価 <br> ※demand_type=0,1の場合のみ必須 <br> 両端のスペース除去                                                                                                                                                                                                                                                           | 整数10,小数4 | 数値       |
| quantity                  | 数量 <br> ※demand_type=0,1の場合のみ必須 <br> 両端のスペース除去                                                                                                                                                                                                                                                           | 整数6,小数2  | 数値       |
| unit                      | 単位                                                                                                                                                                                                                                                                                                                       | 3            | 文字列     |
| tax_category              | 税区分 <br> 0:外税 1:内税 2:対象外 3:非課税 <br> ※必須                                                                                                                                                                                                                                                                     | 1            | 数値       |
| tax                       | 消費税率 <br> 画面上で選択できる消費税率のみ入力可能 <br> ※tax_category=0の場合のみ必須。その他はNULL固定。                                                                                                                                                                                                                | 2            | 数値       |
| remark                    | 備考                                                                                                                                                                                                                                                                                                                       | 60×17行      | 文字列     |
| billing_method            | 請求方法 <br> 0:送付なし 1:自動メール 2:手動メール 3:自動郵送 <br> 4:手動郵送 5:自動メール+自動郵送 6:手動メール+手動郵送 <br> ※必須 <br> 以下の承認を利用している場合、対応する請求方法を指定するとエラー <br> 請求書メール送付承認：自動メール <br> 請求書郵送承認：自動郵送 <br> 請求書メール+郵送：自動メール+自動郵送 | 1            | 数値       |
| repetition_period_number  | 繰返し周期 <br> 1～50 <br> ※demand_type=1,2の場合のみ必須                                                                                                                                                                                                                                                                  | 2            | 数値       |
| repetition_period_unit    | 繰返し周期単位 <br> 1:月 <br> ※demand_type=1,2の場合のみ必須                                                                                                                                                                                                                                                               | 1            | 数値       |
| start_date                | サービス提供開始日 <br> yyyy/mm/dd <br> ※必須                                                                                                                                                                                                                                                                              | 10           | 日付       |
| repeat_count              | 繰返し回数 <br> 0:設定しない または1～36 <br> ※demand_type=1,2の場合のみ必須                                                                                                                                                                                                                                               | 2            | 数値       |
| period_format             | 対象期間形式 <br> 0：○年○月分 <br> 1：○年○月○日分 <br> 2：○年○月～○年○月 <br> 3：○年○月○日～○年○月○日 <br> 99：非表示 <br> ※必須                                                                                                                                                                                           | 2            | 数値       |
| period_value              | 対象期間 <br> 入力可能値:1～31 <br> ※period_format=2,3の場合のみ必須                                                                                                                                                                                                                                                       | 2            | 数値       |
| period_unit               | 対象期間単位 <br> 1:月 <br> ※period_format=3の場合のみ必須                                                                                                                                                                                                                                                                 | 1            | 数値       |
| period_criterion          | 基準 <br> 0:対象期間開始日 1:対象期間終了日 <br> ※period_format=2,3の場合のみ必須                                                                                                                                                                                                                                          | 1            | 数値       |
| issue_month               | 請求書発行日_月 <br> 入力可能値:-36～36 <br> ※必須                                                                                                                                                                                                                                                                         | 2            | 数値       |
| issue_day                 | 請求書発行日_日 <br> 入力可能値:1～30、99(末日) <br> ※必須                                                                                                                                                                                                                                                                 | 2            | 数値       |
| sending_month             | 請求書送付日_月 <br> 入力可能値:-36～36 <br> ※必須                                                                                                                                                                                                                                                                         | 2            | 数値       |
| sending_day               | 請求書送付日_日 <br> 入力可能値:1～30、99(末日) <br> ※必須                                                                                                                                                                                                                                                                 | 2            | 数値       |
| deadline_month            | 決済期限_月 <br> 入力可能値:-36～36 <br> ※必須                                                                                                                                                                                                                                                                             | 2            | 数値       |
| deadline_day              | 決済期限_日 <br> 入力可能値:1～30、99(末日) <br> ※必須                                                                                                                                                                                                                                                                     | 2            | 数値       |
| bill_template_code        | 請求書テンプレートコード <br> 10000:基本テンプレート <br> ※必須 <br> ※合計請求書をご利用される場合は、お手数ですがお問い合わせください                                                                                                                                                                                     | 20           | 数値       |
