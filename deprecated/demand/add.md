...
| billing_individual_number | 請求先部署番号  <br> 両端のスペース除去                                                                                      | 20           | 数値                               | [(必須)^1](/README.md#必須) |
| billing_individual_code   | 請求先部署コード  <br> 両端のスペース除去                                                                                    | 20           | [半角英数\*4](/README.md#種別注釈) | [(必須)^1](/README.md#必須) |
