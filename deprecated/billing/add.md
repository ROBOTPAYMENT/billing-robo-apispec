...
| access_key               | アクセスキー                                                                                                                                                    | 100  | 半角英数*4         | 必須 |
| billing_code             | 請求先コード  <br> 両端のスペース除去                                                                                                                           | 20   | 半角英数*4         | 必須 |
...
| link_customer_code       | 会計ソフト連携用取引先コード                                                                                                                                    | 20   | 半角英数*3         | 必須 |
...
| email                    | メールアドレス <br> 両端のスペース除去                                                                                                                          | 100  | 半角英数*1         | 必須 |
