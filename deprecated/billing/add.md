...
| access_key               | アクセスキー <br> ※必須                                                                                                                                                    | 100  | 半角英数*4         |
| billing_code             | 請求先コード <br> ※必須 <br> 両端のスペース除去                                                                                                                            | 20   | 半角英数*4         |
| billing_name             | 請求先名 <br> ※必須 <br> 両端のスペース除去                                                                                                                                | 100  | 文字列             |
| billing_individual_code  | 請求先部署コード <br> 両端のスペース除去                                                                                                                                   | 20   | 半角英数*4         |
| billing_individual_name  | 請求先部署名 <br> ※必須 <br> 両端のスペース除去                                                                                                                            | 100  | 文字列             |
| link_customer_code       | 会計ソフト連携用取引先コード                                                                                                                                               | 20   | 半角英数*3         |
| address1                 | 宛名1 <br> ※必須 <br> 両端のスペース除去                                                                                                                                   | 60   | 文字列             |
| address2                 | 宛名2 <br> ※両端のスペース除去                                                                                                                                             | 60   | 文字列             |
| address3                 | 宛名3 <br> ※両端のスペース除去                                                                                                                                             | 60   | 文字列             |
| zip_code                 | 郵便番号 <br> ※必須 <br> 両端のスペース除去                                                                                                                                | 7    | 数値               |
| pref                     | 都道府県 <br> ※必須                                                                                                                                                        | 4    | 文字列             |
| city_address             | 市区町村番地 <br> ※必須 <br> 両端のスペース除去                                                                                                                            | 56   | 文字列             |
| building_name            | 建物名 <br> ※両端のスペース除去                                                                                                                                            | 60   | 文字列             |
| set_post_address         | 郵送宛先情報 <br> 0:使用しない 1:使用する <br> ※両端のスペース除去                                                                                                         | 1    | 数値               |
| post_address1            | 郵送先宛名1 <br> ※郵送宛先情報が1の場合に必須 <br> 両端のスペース除去                                                                                                      | 60   | 文字列             |
| post_address2            | 郵送先宛名2 <br> ※両端のスペース除去                                                                                                                                       | 60   | 文字列             |
| post_address3            | 郵送先宛名3 <br> ※両端のスペース除去                                                                                                                                       | 60   | 文字列             |
| post_zip_code            | 郵送先郵便番号 <br> ※郵送宛先情報が1の場合に必須 <br> 両端のスペース除去                                                                                                   | 7    | 数値               |
| post_pref                | 郵送先都道府県 <br> ※郵送宛先情報が1の場合に必須                                                                                                                           | 4    | 文字列             |
| post_city_address        | 郵送先市区町村番地 <br> ※郵送宛先情報が1の場合に必須                                                                                                                       | 56   | 文字列             |
| post_building_name       | 郵送先建物名 <br> ※両端のスペース除去                                                                                                                                      | 60   | 文字列             |
| tel                      | 電話番号 <br> ※payment_method=1,2,6,7の場合のみ必須 <br> 両端のスペース除去                                                                                                | 15   | 数値、半角ハイフン |
| email                    | メールアドレス <br> ※必須 <br> 両端のスペース除去                                                                                                                          | 100  | 半角英数*1         |
| cc_email                 | CC送信先メールアドレス <br> ※両端のスペース除去                                                                                                                            | 256  | 半角英数*1         |
| bs_owner_code            | 請求元担当者コード <br> ※両端のスペース除去                                                                                                                                | 20   | 半角英数*4         |
| payment_method           | 決済手段 <br> 0:銀行振込 1:クレジットカード 2:バンクチェック <br> 3:RP口座振替 4:RL口座振替 5:その他口座振替 <br> 6:コンビニ払込票(A4) 7:コンビニ払込票(ハガキ) <br> ※必須 | 1    | 数値               |
| source_bank_account_name | 振込元口座名義 <br> ※payment_method=0,2の場合に必要(入力は任意)                                                                                                            | 48   | 半角英数*5         |
| credit_number            | クレジットカード番号(ハイフンはつけない) <br> ※payment_method=1の場合のみ必須 <br> 両端のスペース除去                                                                      | 20   | 数値               |
| credit_expiration_date   | クレジットカード有効期限(YYMM形式) <br> ※payment_method=1の場合のみ必須 <br> 両端のスペース除去                                                                            | 4    | 数値               |
| credit_first_name        | クレジットカード名義(名) <br> ※payment_method=1の場合のみ必須 <br> 両端のスペース除去                                                                                      | 20   | 半角英数*2         |
| credit_last_name         | クレジットカード名義(姓) <br> ※payment_method=1の場合のみ必須 <br> 両端のスペース除去                                                                                      | 20   | 半角英数*2         |
| customer_number          | 顧客番号 <br> ※payment_method=5の場合に必要(入力は任意)                                                                                                                    | 20   | 半角英数*3         |
...
| bank_account_type        | 預金種目 <br> 1:普通 2:当座 <br> ※payment_method=3,4,5の場合に必須                                                                                                         | 1    | 数値               |
| bank_account_number      | 口座番号 <br> ※payment_method=3,4,5の場合に必要(入力は任意) <br> ※payment_method=3でゆうちょの時の桁数は8桁固定                                                            | 7    | 数値               |
| bank_account_name        | 口座名義 <br> ※payment_method=3,4,5の場合に必要(入力は任意) <br> ※payment_method=3時の桁数は30桁                                                                           | 100  | 半角英数*5         |
| ref_billing_code         | 合計請求書用請求先コード <br> ※合計請求書用請求先部署番号、合計請求書用請求先部署コードのいずれかが指定された場合に必須                                                    | 20   | 半角英数*4         |
| ref_individual_number    | 合計請求書用請求先部署番号 <br> ※合計請求書の場合、「合計請求書用請求先部署番号」または「合計請求書用請求先部署コード」何れかを必須                                        | 20   | 数値               |
| ref_individual_code      | 合計請求書用請求先部署コード <br> ※合計請求書の場合、「合計請求書用請求先部署番号」または「合計請求書用請求先部署コード」何れかを必須                                      | 20   | 半角英数*4         |
| bill_template_code       | 請求書テンプレートコード <br> ※合計請求書をご利用される場合は、お手数ですがお問い合わせください                                                                            |      | 数値               |
| payment_method_code      | 決済情報コード                                                                                                                                                             | 20   | 半角英数*4         |
